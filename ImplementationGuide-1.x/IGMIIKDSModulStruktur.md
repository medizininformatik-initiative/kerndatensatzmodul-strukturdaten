# Kerndatensatz Modul Strukturdaten

| Hinweis | Under Construction! |
|---------|---------------------|
| {{render:ImplementationGuide-Common/images/Warning.jpg}} | Dieser Implementation Guide stellt die aktuelle Arbeitsversion des Moduls 'Strukturdaten' dar. Die jeweils für den produktiven Einsatz veröffentlichte Version finden Sie auf [dieser Seite der Medizininformatik-Initiative]().|

Die vorliegende Spezifikation beschreibt die FHIR-Repräsentation des Kerndatensatz Moduls 'Strukturdaten' der Medizinformatik-Initative.
...
## Ansprechpartner
* Matthias Löbe (Institut für Medizinische Informatik, Statistik und Epidemiologie Leipzig)
* Martin Schöbel (Gesundheitsforen Leipzig GmbH)
